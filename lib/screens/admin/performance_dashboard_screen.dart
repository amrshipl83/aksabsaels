...
class PerformanceDashboardScreen extends StatefulWidget {
  final String targetDocId; // معرف الوثيقة (مشرف أو مندوب)
  final String targetType;  // 'sales_supervisor' أو 'sales'
  final String targetName;
  final String? repCode;    // يُرسل فقط في حالة المندوب
...
class _PerformanceDashboardScreenState extends State<PerformanceDashboardScreen> {
  ...
  Widget _buildKpiGrid(Map<String, dynamic> currentTarget) {
    ...
    int visitsGoal = (currentTarget['visitsTarget'] ?? 0);
